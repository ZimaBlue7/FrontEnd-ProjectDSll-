...
export default function EditableUserProfile({
    ...
    return <>
        <Group>            
            <h2 className='tituloPerfil' >Name:</h2>
            <input
                type='text'
                value={name}
        ...
        <Group>            
            <h2 className='tituloPerfil' >Birthday:</h2>            
        ...
        <Group>            
            <h2 className='tituloPerfil'>Favourite Color:</h2>
            <input
                type="color"
                value={color}
        ...
        <Group>
            <button className='buttonPerfil' style={buttonStyle} onClick={handleSaveClicked}>Save</button>
            <button className='buttonPerfil' style={buttonStyle} onClick={handleCancelClicked}>Cancel</button>
        </Group>
    </>
}